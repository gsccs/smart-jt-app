...
class HighlightView {
	...
	private void init() {
		...
		mResizeDrawableWidth = resources.getDrawable(R.drawable.photo_camera_crop_width);
		mResizeDrawableHeight = resources.getDrawable(R.drawable.photo_camera_crop_height);
		mResizeDrawableDiagonal = resources.getDrawable(R.drawable.photo_indicator_autocrop);
	}
	...
	protected void draw(Canvas canvas) {
		...
		if (!hasFocus()) {
			...
			if (mCircle) {
				...
				mOutlinePaint.setColor(0xFF00E000);
			} else {
				path.addRect(new RectF(mDrawRect), Path.Direction.CW);
				mOutlinePaint.setColor(0xFF40FF40);
			}
