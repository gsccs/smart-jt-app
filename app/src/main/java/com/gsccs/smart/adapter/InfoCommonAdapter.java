 ...
 */
public class InfoCommonAdapter extends BaseAdapter {
    ...
    public InfoCommonAdapter(Context context, List<TweetsEntity> dataList){
    ...
    public View getView(int position, View convertView, ViewGroup parent){
        ...
        if (null != comment){
            ...
            holder.nickname.setText(dataList.get(position).getUsername());
            holder.time.setText(dataList.get(position).getAddtimestr());
