...
public class UpdateDialog extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        builder.setMessage(getArguments().getString(BaseConst.APK_UPDATE_CONTENT))
    ...
    private void goToDownload() {
    	...
    	intent.putExtra(BaseConst.APK_DOWNLOAD_URL, getArguments().getString(BaseConst.APK_DOWNLOAD_URL));
