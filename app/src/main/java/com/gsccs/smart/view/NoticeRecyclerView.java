...
public class NoticeRecyclerView extends RecyclerView {
     ...
     */
    private NoticeListAdapter mAutoLoadAdapter;
    /**
     * 是否允许加载更多
     */
    ...
    public NoticeRecyclerView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public NoticeRecyclerView(Context context, AttributeSet attrs, int defStyle) {
   ...
   @Override
    public void setAdapter(Adapter adapter) {
        if (adapter != null) {
            mAutoLoadAdapter = (NoticeListAdapter)adapter;
        }
