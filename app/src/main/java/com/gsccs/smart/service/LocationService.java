...
public class LocationService extends Service implements AMapLocationListener{
    ...
    public void onDestroy() {
        ...
        if(null != startPoiSearchServiceIntent){
            stopService(startPoiSearchServiceIntent);
        }
    }


    private Intent startPoiSearchServiceIntent;
    private Intent startWeatherServiceIntent;
...
//        Log.i("testAki","poiService启动次数:第" + COUNT + "次");
        ...
        startWeatherServiceIntent = new Intent(LocationService.this,WeatherService.class);
        LocationMessage locationMessage = null;
        if (aMapLocation != null) {
            if (aMapLocation.getErrorCode() == 0) {
                errorStatus.setReturnCode(aMapLocation.getErrorCode());
                ...
                locationMessage = new LocationMessage()
                        ...
                        startPoiSearchServiceIntent.putExtra("Location",locationMessage);
                        startWeatherServiceIntent.putExtra("cityName",locationMessage.getCity());
            } else {
...
//            Log.i("Aki","----------");
        ...
        startWeatherServiceIntent.putExtra("ErrorStatus",errorStatus);
    ...
    public void startPoiSearch(){
        startService(startPoiSearchServiceIntent);
        startService(startWeatherServiceIntent);
