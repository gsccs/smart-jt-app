 ...
 *  便捷洗车
 */
public class WashcarActivity extends Activity implements View.OnClickListener {
    ...
    AssistAdapter mAdapter = new AssistAdapter(corpList);
        ...
        public void handleMessage(android.os.Message msg) {
            switch (msg.what) {
                case BaseConst.WHAT_WASHCAR_PAGELIST:
                    ...
                    if (list.size() == 0) {
                        SystemToastDialog.showShortToast(WashcarActivity.this, "没有更多符合条件的数据");
                    }
                    SystemToastDialog.showShortToast(WashcarActivity.this, "数据列表："+list.size());
                    corpList.clear();
                    corpList.addAll(list);
